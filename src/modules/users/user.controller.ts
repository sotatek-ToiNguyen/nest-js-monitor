import {BadRequestException, Param, Body, Controller, Req, Post, UseGuards, Get, Query} from '@nestjs/common';
...
export class UserController {
    ...
    public async createUser(@Body() user: CreateUserBodyDto): Promise<UserEntity | null>  {
